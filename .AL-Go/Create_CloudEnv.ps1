...
#>
$QA="QA"
$MyProd="MYPROD_Production"

if ($null -eq $reuseExistingEnvironment){
...
C:\DevOps\AlGo001\.AL-Go\cloudDevEnv.ps1 -environmentName $MyProd -reuseExistingEnvironment $reuseExistingEnvironment
# Senario 3
